...
Wei Lu, Si-Bao Chen, Qing-Ling Shu, Jin Tang, Bin Luo
IEEE Transactions on Geoscience and Remote Sensing (TGRS), 2024
Source: https://github.com/AeroVILab-AHU/DecoupleNet
"""
import torch
...
class DecoupleNet(BaseModule):
    ...
    def __init__(self,
        ...
        # add a norm layer for each output stage
